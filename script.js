(function () {
  ...
  const sections = [
    ...
    },
    {
      ...
      railText: "Категории продукта без неподтвержденных составов, норм и заявлений.",
      status: "Продукция",
      ...
      facts: [
        ...
        ["Документы", "Инструкции и материалы добавляются после проверки."]
      ],
    ...
    {
      id: "schemes",
      label: "Схемы и услуги",
      railTitle: "Культура → задача → сервис",
      railText: "Схемы защиты, питание, агросопровождение и полевые сервисы собраны в один раздел.",
      status: "Схемы и услуги",
    ...
    return `
      <div class="section-shell">
        <div class="section-header">
          ...
          <p>Каталог собран по направлениям. Точные позиции, составы, фасовки, наличие и цены добавляются только после проверки.</p>
        </div>
    ...
    return `
      <div class="section-shell">
        <div class="section-header">
          ...
          <p>Янтари работает как собственное продуктовое направление внутри Pesticides RU. Точные составы, нормы и регламенты применения уточняются для финальной версии сайта.</p>
        </div>
  ...
  function renderSchemes() {
    ...
    return `
      <div class="section-shell">
        <div class="section-header">
          <span class="meta-label">Культуры · сервис</span>
          <h1>Схемы защиты, питание и сервис под задачу хозяйства</h1>
          <p>Выберите культуру, чтобы увидеть предварительную логику этапов. Здесь же собраны сервисные направления: подбор, консультация, диагностика и полевые работы.</p>
        </div>
        ...
        <div class="service-grid">
          ${services.map(([title, text]) => renderCard(title, text, "Сервис")).join("")}
        </div>
        <div class="action-row">
